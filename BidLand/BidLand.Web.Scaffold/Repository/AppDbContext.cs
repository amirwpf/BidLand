...
using BidLand.Web.Scaffold.Repository.Models;
using Microsoft.EntityFrameworkCore;

namespace BidLand.Web.Scaffold.Repository;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasOne(d => d.Seller).WithMany(p => p.Files).HasConstraintName("FK_File_Seller");
        });

        modelBuilder.Entity<Image>(entity =>
        {
            entity.HasIndex(e => e.SellerId, "IX_Images_SellerId")
                .IsUnique()
                .HasFilter("([SellerId] IS NOT NULL)");
