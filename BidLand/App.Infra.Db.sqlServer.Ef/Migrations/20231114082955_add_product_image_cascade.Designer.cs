...
namespace App.Infra.Db.sqlServer.Ef.Migrations
{
    ...
    [Migration("20231114082955_add_product_image_cascade")]
    partial class add_product_image_cascade
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("App.Domin.Core._01_Purchause.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Description = "شرح ",
                            InsertionDate = new DateTime(2023, 11, 14, 11, 59, 55, 373, DateTimeKind.Local).AddTicks(8846),
                            Name = "لوازم خانگی"
                        },
                        new
                        {
                            Id = 2,
                            Description = "شرح ",
                            InsertionDate = new DateTime(2023, 11, 14, 11, 59, 55, 373, DateTimeKind.Local).AddTicks(8898),
                            Name = "یخچال و فریز",
                            ParentId = 1
                        },
                        new
                        {
                            Id = 3,
                            Description = "شرح ",
                            InsertionDate = new DateTime(2023, 11, 14, 11, 59, 55, 373, DateTimeKind.Local).AddTicks(8901),
                            Name = "صوتی و تصویری",
                            ParentId = 1
                        },
                        new
                        {
                            Id = 4,
                            Description = "شرح ",
                            InsertionDate = new DateTime(2023, 11, 14, 11, 59, 55, 373, DateTimeKind.Local).AddTicks(8904),
                            Name = "لباسشویی",
                            ParentId = 1
                        });
                });
